...
const dashboardController = require("../../controllers/adminContoller/dashboardController");

// Dashboard stats endpoint
router.get("/stats", verifyToken, requireAdmin, dashboardController.getDashboardStats);
router.get("/dashboard-stats", verifyToken, requireAdmin, dashboardController.getDashboardStats); // Legacy support
