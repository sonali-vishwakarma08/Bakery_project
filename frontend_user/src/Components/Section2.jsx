    ...
    <div className="flex flex-col md:flex-row items-center justify-between p-6 sm:p-10 bg-[#fdf1f0]">
      <div className="w-full md:w-1/2 p-3 space-y-6 text-center md:text-left lg:ml-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4 items-center md:items-start justify-center md:justify-start">
          ...
          className="relative bg-white text-black rounded-full w-[150px] h-10 bg-gradient-to-r from-[#D9526B] to-[#F2BBB6] hover:opacity-90 transition">
          ...
          className="bg-gradient-to-r from-[#D9526B] to-[#F2BBB6] text-black cursor-pointer font-medium rounded-full h-10 w-[150px] hover:opacity-90 transition border border-white">
            View Menu
          </button>
        </div>
