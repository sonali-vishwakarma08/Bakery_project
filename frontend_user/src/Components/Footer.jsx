    ...
    <footer className="bg-white">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-16 px-6 sm:px-10 lg:px-16">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          />
          <h1 className="text-[#E53894] font-bold text-2xl">
            The Velvet Delights
          </h1>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center py-6 px-6 sm:px-10 lg:px-16 gap-4 lg:ml-10">
        ...
        <div className="flex gap-6">
          <Link
            to="/privacy"
            className="text-gray-700 font-medium hover:text-[#c13f5e] lg:ml-30"
          >
            Privacy
          </Link>
          <Link
            to="/terms"
            className="text-gray-700 font-medium hover:text-[#c13f5e] lg:mr-40"
          >
            Terms
          </Link>
        </div>
