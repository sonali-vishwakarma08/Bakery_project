...
const orderController = require('../../controllers/adminContoller/orderController');
...
router.get('/my', authMiddleware.verifyToken, authMiddleware.requireCustomer, orderController.getMyOrders);
